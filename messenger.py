...
class BasicMessenger:
    ...
    def encrypt_symmetric(self, message):
        ...
        encrypted_message = fernet.encrypt(message.encode()) #encoding the string message into bytes (a requirement for Fernet)
    ...
    def decrypt_symmetric(self, encrypted_message):
        ...
        string_message = decrypted_message.decode() #decode the encoding I mentioned above
